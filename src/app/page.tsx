...
<section className="relative w-full pt-12 md:pt-16 lg:pt-20 pb-16 md:pb-20 lg:pb-24 overflow-hidden group">

  {/* Background Gradient */}
  <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-background to-background z-0" />

  <div className="container relative z-10 grid gap-12 px-4 md:px-6 lg:grid-cols-2 lg:gap-20 items-center">

    {/* RIGHT IMAGE */}
    <div className="w-full flex justify-center items-center">
      <div className="relative w-full aspect-[4/3] md:max-w-lg rounded-2xl overflow-hidden shadow-2xl animate-float">
        {heroImage && (
          <Image
      ...
      {/* Floating Card */}
      <div className="absolute -bottom-4 left-4 bg-white shadow-xl rounded-xl px-5 py-3 hidden md:block">
        <p className="text-sm font-semibold text-primary">✔ Trusted Platform</p>
        <p className="text-xs text-muted-foreground">Secure & Transparent</p>
      </div>
    </div>

    {/* LEFT CONTENT (Text) */}
    <div className="space-y-6 text-center lg:text-left animate-fade-in lg:mt-0 mt-6">
      {/* Badge */}
      ...
      {/* Heading */}
      <h1 className="font-headline text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl leading-tight">
        Public Grievance  
      ...
      <p className="max-w-[600px] text-muted-foreground text-base sm:text-lg md:text-xl mx-auto lg:mx-0">
        A unified digital platform empowering citizens to report civic issues, 
        track complaints in real-time, and engage with transparent governance.
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
        <Button 
          asChild 
          size="lg" 
          className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition"
        >
...
`}</style> */}
      ...
      <footer className="bg-[#0B3D91] text-sidebar-foreground border-t border-sidebar-border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="md:col-span-1 space-y-4">
                    <Link href="/" className="flex items-center gap-3">
                        <AshokaChakraLogo />
                        <div>
                            <span className="block font-headline text-xl font-semibold text-sidebar-foreground leading-tight">civicConnect</span>
